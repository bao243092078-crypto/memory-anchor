  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <p className="mt-4 text-sm text-gray-400 font-medium">Loading memories...</p>
      </div>
    );
  }
      ...
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <p className="text-sm text-gray-500 text-center max-w-sm">
          {searchQuery
            ...
            : 'Memories will appear here once added'
          }
        </p>
      </div>
    );
      ...
      {searchQuery && (
        <div className="flex items-center gap-2 mb-6">
          <span className="text-sm text-gray-500">
            Found <span className="font-semibold text-gray-900">{memories.length}</span> {memories.length === 1 ? 'result' : 'results'}
          </span>
